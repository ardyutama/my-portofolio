...
<div class="flex flex-col items-center self-stretch gap-6">
		...
		<section id="me" bind:this={node} class="min-h-screen">
			{#if intersecting}
				...
				>
					...
					{#key description}
						<div class="self-stretch text-justify" in:fade={{ delay: 250, duration: 300 }}>
							{description}
						</div>
					{/key}
				</div>
	...
	>
		<IntersectionObserver element={nodeExperiences} let:intersecting threshold={1} once>
	...
	<section id="skills" class="flex flex-col w-full min-h-screen gap-6 px-6 py-3 mt-16">
