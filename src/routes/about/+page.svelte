	...
	const experiences = [
		{
			...
			company: 'Pinhome',
			skills: ['Jest Unit', 'Javascript', 'ReactJS', 'TailwindCSS', 'Storybook', 'Figma']
		}
	];
...
<div class="flex flex-col items-center self-stretch gap-6">
			...
			{#if intersecting}
				...
				>
					...
					<div class="flex flex-wrap items-start content-start gap-2 md:justify-center">
						...
						{#key description}
							<div
								class="max-w-[675px] text-justify"
	...
	<section
		id="experiences"
		class="bg-[#1D5D9B] min-h-screen w-full flex justify-center items-center md:grid md:grid-cols-12 md:gap-6 md:px-[172px]"
	>
		<div
			use:inview
		...
		>
			{#if intersectingExperiences}
				...
				>
					<p class="text-subheading-2 font-[700] text-white">This is my latest experiences,</p>
									...
									<div class="flex flex-col items-start self-stretch gap-2 pb-6">
										...
										<div class="flex flex-wrap gap-1 flex-start">
											{#each experience.skills as skill}
												<p
													class="px-2 py-1 rounded-[16px] border-white text-white border-[1px] text-[12px]"
												>
													{skill}
												</p>
											{/each}
	...
	<section id="skills" class="flex flex-col items-center w-full min-h-screen gap-6 px-6 py-3 mt-16 md:">
		...
		<div class="flex flex-col items-center self-stretch gap-3">
			...
			<div class="flex flex-wrap">
				<p
					class="px-2 py-1 rounded-[16px] border-[#1D5D9B] text-[#1D5D9B] border-[1px] text-[12px]"
				>
					Jest Unit
				</p>
			</div>
